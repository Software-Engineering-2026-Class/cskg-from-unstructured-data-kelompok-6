...
|---|---|---|
| Plumz17 (Anders Emmanuel Tan) | 24/541351/PA/22964 | Menambahkan integrasi NVD CVE API dan CIRCL CVE Feed ke scraper serta memperluas proses ekstraksi informasi kerentanan; mengupdate model Gemini; menambahkan CWE linking; memperbaiki kueri use case 2; menyelesaikan isu yang kurang lengkap. |
